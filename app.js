...
class App {
    constructor() {
        ...
        lightToggle.innerText = 'Toggle Light';
        lightToggle.style.position = 'absolute';
        lightToggle.style.bottom = '50px';
        lightToggle.style.left = '10px';
        lightToggle.style.padding = '10px';
        ...
        lightToggle.addEventListener('click', () => {
            ...
            this.scene.traverse(obj => {
                if (obj.isLight) obj.visible = lightOn;
            });
        });
        ...
        audioLoader.load('./assets/sounds/door.mp3', (buffer) => {
    ...
    render(timestamp, frame) {
        ...
        if (this.renderer.xr.isPresenting) {
            ...
            if (this.useGaze && this.gazeController !== undefined) {
                ...
                // highlight gaze object
                const hovered = this.gazeController.intersected;
                if (hovered && hovered.object && hovered.object.material) {
                    hovered.object.material.emissive = new THREE.Color(0x3333ff);
                }
            }
